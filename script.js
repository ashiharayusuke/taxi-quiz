const quizData = [
  ...
  },
  {
    ...
    answer: 2,
    explanation: "付け待ちが苦手で常に走り回る流し専門のドライバー。マグロが常に泳いでいないと窒息してしまうことになぞらえてこう呼ぶ。"
  },
  {
    question: "「げそ」とは？",
  ...
  {
    question: "「お茶」とは？",
    choices: ["お客のドタキャン", "整備依頼", "休憩申請", "高速申請"],
    answer: 0,
  ...
  },
  {
    ...
    answer: 0,
    explanation: "タクシーメーターを正しく操作しないで、運賃をドライバーが着服する不正行為のこと。昔のメーター器はアナログ方式で、横に倒すと作動を開始する。旗が立ったままなのでエントツという。今はデジタル方式だが、慣習で用いられる。"
  },
  {
    question: "「ハンドル」とは？",
  ...
  {
    question: "「ベタ」とは？",
    choices: ["高速に対する一般道", "速度制限ギリギリの運行", "幽霊", "相乗り"],
    answer: 0,
    explanation: "高速道路ではない一般道路。または、一般道路を走る事。地べたから。"
  },
  {
    question: "「まんしゅう」とは？",
    choices: ["1万円以上の長距離乗車", "大型車", "長時間休憩", "長時間待機"],
    answer: 0,
    explanation: "1「万」円以上の「収」入から。"
  },
  {
    question: "「ワンメーター」とは？",
  ...
  },
  {
    ...
    answer: 1,
    explanation: "駅構内等のタクシー乗り場でスペースに入りきれず構内に入る為停車している状態。"
  },
  {
    question: "「昆虫採集」とは？",
...
shareBtn.addEventListener("click", () => {
  const text = `#タクシー業界用語クイズ で${shuffledQuiz.length}問中 ${score}問正解しました！%0Aあなたも挑戦！`;
