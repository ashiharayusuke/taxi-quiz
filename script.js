const quizData = [
  ...
  },
  {
    ...
    answer: 1,
    explanation: "東京のタクシーは4人まで乗車できるが、その4人お客様が乗って千円以内の場所に行くこと。由来は「お客さんが一気にあがるから」「商売あがったり」など諸説あり。"
  },
  {
    question: "「お茶」とは？",
    choices: ["ドタキャン", "整備依頼", "休憩申請", "高速申請"],
    answer: 0,
    explanation: "無線配車されて、迎えに行ってもキャンセルや利用者がいないこと。「お茶を飲むほど時間が空く」「お茶を飲んで休憩するしかない」ことから。"
  },
  {
    question: "「○珍良好」とは？",
